...
from . import views
from .views import base, delete_data, upload_data, predict_csv_single, predict_csv_multi, predict_data_manually, \
    view_data, retrieve_data_by_id, analysis, change_password, login2, account_details, add_files_multi, about, \
    dashboard, userLogout, reports, upload_credit_data, prediction_button, enter_form_data_manually, add_files_single, \
    predict_realtime, prediction_list, prediction_detail
...
urlpatterns = [
    ...
    path('realtime/', views.predict_realtime, name='predict_realtime'),
    path('predictions/', views.prediction_list, name='historique_predictions'),
    path('predictions/<int:id>/', views.prediction_detail, name='prediction_detail'),
    path('predictions/delete/<int:id>/', views.delete_prediction, name='delete_prediction'),
    path("analyze/", views.analyze_predictions, name="analyze_predictions"),
